...
@Data
@NoArgsConstructor
public class StandarizedApiExceptionResponseProduct {
    ...
    public StandarizedApiExceptionResponseProduct(String type,String title,String code,String datail,String instance) {
        super();
        this.type = type;
        this.title = title;
        this.code = code;
