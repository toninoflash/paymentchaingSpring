...
public class ApiExceptionHadler {
    ...
    public ResponseEntity<?> hadlerUnknownHostException(Exception ex) {
        StandarizedApiExceptionResponse standarizedApiExeptionResponse = new StandarizedApiExceptionResponse("Tecnico", "Input Ouput error", "0001", ex.getMessage(), ex.getLocalizedMessage());
    ...
    public ResponseEntity<?> hadlerBusinessRuleException(BusinessRuleException ex) {
        StandarizedApiExceptionResponse standarizedApiExeptionResponse = new StandarizedApiExceptionResponse("Business", "Error", ex.getCode(), ex.getMessage(), ex.getLocalizedMessage());
